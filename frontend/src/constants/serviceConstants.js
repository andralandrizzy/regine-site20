...
// Service List Details constant type
...
export const SERVICE_HOME_REQUEST = 'SERVICE_HOME_REQUEST'
export const SERVICE_HOME_SUCCESS = 'SERVICE_HOME_SUCCESS'
export const SERVICE_HOME_FAIL = 'SERVICE_HOME_FAIL'
